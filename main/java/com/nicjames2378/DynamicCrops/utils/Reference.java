package com.nicjames2378.DynamicCrops.utils;

public class Reference {

	public static final String MOD_ID = "dynamiccrops";
	public static final String NAME = "Dynamic Crops";
	...
	public static final String CONFIG_NAME = "modtut.cfg";
}
